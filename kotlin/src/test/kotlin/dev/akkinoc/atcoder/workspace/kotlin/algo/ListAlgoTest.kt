...
class ListAlgoTest {
    ...
    @Test
    fun `test - perm`() {
        listOf('A', 'B', 'C').perm().shouldContainExactly(
        ...
        emptyList<Any>().perm().shouldContainExactly(emptyList())
    }

    @Test
    fun `test - rperm`() {
        listOf('A', 'B', 'C').rperm().shouldContainExactly(
        ...
        emptyList<Any>().rperm().shouldContainExactly(emptyList())
    }

    @Test
    fun `test - comb`() {
        listOf('A', 'B', 'C').comb().shouldContainExactly(listOf('A', 'B', 'C'))
        ...
        emptyList<Any>().comb().shouldContainExactly(emptyList())
    }

    @Test
    fun `test - rcomb`() {
        listOf('A', 'B', 'C').rcomb().shouldContainExactly(
            listOf('A', 'A', 'A'), listOf('A', 'A', 'B'), listOf('A', 'A', 'C'),
        ...
        emptyList<Any>().rcomb().shouldContainExactly(emptyList())
    }
